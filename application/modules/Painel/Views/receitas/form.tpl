			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						...
						{* cria os campos manualmente *}
						{$this->formField($core_model, "titulo", $core_row)}
						{$this->formField($core_model, "idreceita_categoria", $core_row)}
						{$this->formField($core_model, "conteudo", $core_row)}
